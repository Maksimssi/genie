				...
				<div class="container">
					...
					<div class="swiper-used">
						<div class="swiper-wrapper">
							...
							<div class="swiper-slide slide-1 float-grid">
							<c:forEach var="n3" items="${li3 }">
								<div class="slide_1">
									<div class="inner">
										<div class="tag-box">
											<ul>
												<li class="book-category">
													<span>${n3.category }</span>
												</li>
												<!-- <li class="book-event">
													<span class="book-event_title">관련 이벤트</span>
												</li> -->
										...
										<a href="index?booknum=${n3.booknum}">
										<c:if test="${sessionScope.sessionAge ge n3.grade}" >
					                           <div class="img-box">
					                                    <img src="${pageContext.request.contextPath}/image/book/${n3.bookimg}"
					                                                alt="">
                                               </div>
			                           </c:if>   
				                       <c:if test="${sessionScope.sessionAge lt n3.grade}" >   
				                          <div class="img-box">
				                                    <img src="${pageContext.request.contextPath}/image/book/19book_200cover.jpg"
				                                                alt="">
			                                                </div>
										...
										<div class="text-box text-box_bg">
											<h2 class="book-title">${n3.title }</h2>
											<p class="book-writer">${n3.author }</p>
											<!-- <p class="book-des">이것이 지극한 사랑에 대한 소설이기를 빈다.</p> -->
										</div>
									</div>
								</div>
