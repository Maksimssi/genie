...
<div class="min_height">
			...
			<article id="bandiContainer" style="">
				...
				<!-- 책정보 ---------------------------------------------------------------------->
				<c:if test="${li.isEmpty()}">

						<br>
						<li>
							<div style="font-size: 15px; text-align: center;">등록대기중인 도서가 없습니다.</div>
						</li>
                          ...
                          <img src="${pageContext.request.contextPath}/image/book/19book_200cover.jpg" width="118px"  height="177px" onerror="">   
                              ...
                              <form action="checkBook" method="post">
                                 ...
                                 <span class="btn_type blue"><a
                                  ><button type="submit">상품 등록</button></a></span>
                                  <span class="btn_type white"><a
                                  ><button type="button" onclick="">상품 거절</button></a></span></form>
