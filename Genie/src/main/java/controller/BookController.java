...
public class BookController {
	...
	public String index(String sortmap, String inventory) throws Exception {
		...
		List<Book> li3 = bd.usedBookList();
		req.setAttribute("li3", li3);
	...
	@RequestMapping("rejectBook")
	public String rejectBook(Book book) throws Exception {
		bd.rejectBook(book);
		String msg = "상품등록을 거절하였습니다.";
		String url = "/book/Bookcheck";
		req.setAttribute("msg", msg);
		req.setAttribute("url", url);
		return "alert";
